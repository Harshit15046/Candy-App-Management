...
async function DATAOPER(OBJ){
    try{
        const response = await axios.post('https://crudcrud.com/api/7e5da9b112c247d9acc338db6c851417/candy',OBJ,{
        ...
        ONE.addEventListener('click', async () => {
            try {
                ...
                const updatedResponse = await axios.get(`https://crudcrud.com/api/7e5da9b112c247d9acc338db6c851417/candy/${response.data._id}`);
                ...
                if (candyi >= 1) {
                    ...
                    await axios.put(`https://crudcrud.com/api/7e5da9b112c247d9acc338db6c851417/candy/${updatedCandy._id}`, newobj, {
                        headers: { 'Content-Type': 'application/json' },
                    });
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        const response = await axios.get('https://crudcrud.com/api/7e5da9b112c247d9acc338db6c851417/candy');
        ...
        candyData.forEach(candy => {
            ...
            ONE.addEventListener('click', async () => {
                try {
                    // Fetch the latest data for the product
                    const updatedResponse = await axios.get(`https://crudcrud.com/api/7e5da9b112c247d9acc338db6c851417/candy/${candy._id}`);
                    const updatedCandy = updatedResponse.data;
                    let candyi = parseInt(updatedCandy.quantity);
